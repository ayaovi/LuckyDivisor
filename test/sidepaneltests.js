...
QUnit.test("side panel basics", function(assert) {
     ...
     */
    luckyDivisor.global.currentWorld.playerCube = new PlayerCube(10, 0, createVector(20, 770));
    sidePanel.reset();
...
QUnit.test("side panel cubes position", function(assert) {
     ...
     */
    luckyDivisor.global.currentWorld.playerCube = new PlayerCube(60, 0, createVector(20, 770));
    sidePanel.reset();
...
QUnit.test("side panel cubes cloning tests", function(assert) {
    ...
    var original = luckyDivisor.global.currentWorld.sidePanel;

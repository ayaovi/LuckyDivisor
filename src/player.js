...
class Player {
    ...
    /**
     * @description checks the equality of two players.
     *
     * @param Player.
     *
     * @return boolean.
    ...
    equals(otherPlayer) {
        return (this.name == otherPlayer.name &&
            this.score.equals(otherPlayer.score) &&
            this.bestScore == otherPlayer.bestScore &&
            this.creditPoints == otherPlayer.creditPoints &&
            this.playerLifeStars.length == otherPlayer.playerLifeStars.length);
    }



    /**
     * @description Makes a copy of this player.
     *
     * @param none.
     *
     * @return Player.
    ...
    clone() {
        ...
        clone.score = this.score.clone();
        clone.playerLifeStars = [];

        this.playerLifeStars.forEach(function(star) {
            clone.playerLifeStars.push(star);
        }, this);

        clone.nextPlayerStarPositionX = this.nextPlayerStarPositionX;
        clone.playerLifeStarsLocked = this.playerLifeStarsLocked;
        clone.bestScore = this.bestScore;
        clone.creditPoints = this.creditPoints;

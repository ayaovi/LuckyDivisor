 ...
 * @file : toppanel.js
 *
 * @description : A panel is more of a container to hold the player's life stars, a clock and the player's score.
 *
...
class TopPanel extends Panel {
    ...
    /**
     * @description Tests equality of two top panels.
     *
     * @param TopPanel.
     *
     * @return boolean.
     */
    equals(otherTopPanel) {
        return this.clock.equals(otherTopPanel.clock);
    }


    /**
     * @description Makes a copy of this top panel.
     *
     * @param none.
     *
     * @return TopPanel.
     */
    clone() {
        var clone = new TopPanel();
        clone.clock = this.clock.clone();
        return clone;
    }
}
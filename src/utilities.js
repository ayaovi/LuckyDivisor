...
class Utilities
{
	 ...
	 */
	static generatePlayerCubeNumber()
	{
		/**
		 ...
		 */
		var divisors = Utilities.getPrimeFactors(number);
		...
		while (true)
		{
			...
			else
			{
				...
				divisors = Utilities.getPrimeFactors(number);
	 ...
	 */
	static combineColours(divisors)
	{
	...
	static addRGBs(rgb1, rgb2)
	{
		...
		return Utilities.LABtoRGB(resultingLab);
	}
	 ...
	 * @return none.
	 */
	static removeFromArray(array, target)
	{
	 ...
	 */
	static getTimeDifference(previousMinute, previousSecond, currentMinute, currentSecond)
	{
	 ...
	 * @return 
	 */
	static getStringGameDuration(startMinute, startSecond, currentMinute, currentSecond)
	{
	 ...
	 */
	static getStringTimeTillEndOfPlay(startMinute, startSecond, currentMinute, currentSecond)
	{
	...
	static startPlay()
	{
		...
		var playerCubeNumber = Utilities.generatePlayerCubeNumber();

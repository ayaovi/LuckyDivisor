...
{
	/**
	 * Because there are multile Columns side by side on the game canvas, there is a 
	 ...
	 * demarks the x-coorinate of where a Column starts. And consequently it would 
	...
	{
		this.cubes.push(new Cube(random(primeNumbers), ++ID, createVector(this.x + DEFAULT_COLUMN_PADDING, 0)));
	}
}